...
public class MockDatabase {
    ...
    public static ArrayList<Restaurants> restaurants;


    private MockDatabase() {
        users = new ArrayList<Users>();
        
        users.add(new Users("lisa", "lisa", "simpson", "lisa@simpson.com", "1234"));
        users.add(new Users("homer", "homer", "simpson", "homer@simpson.com", "1234"));
        users.add(new Users("marge", "marge", "simpson", "marge@simpson.com", "1234"));
        users.add(new Users("bart", "bart", "simpson", "bart@simpson.com", "1234"));
        users.add(new Users("maggie", "maggie", "simpson", "maggie@simpson.com", "1234"));
        //with the second construction, we can also create an instance for a restaurant
        users.add(new Users("waffle1", "The Real Waffle", "waffle@gmail.com", "1234")); //added recently
        users.add(new Users("pizza1", "Pomodoro", "pizza@gmail.com", "1234"));
        users.add(new Users("meat1", "Hunter Place", "meat@gmail.com", "1234"));
        users.add(new Users("japanese1", "Oishii Udon", "japanese@gmail.com", "1234"));
        users.add(new Users("korean1", "The spicy House", "korean@gmail.com", "1234"));
           
    
     //restaurants or restaurant        
        restaurants = new ArrayList<Restaurants>(); {
        restaurants.add(new Restaurants("waffle1", "1234", "waffle@gmail.com", "The Real Waffle", "Thoralf", "High Avenue 1",
        ...
        restaurants.add(new Restaurants("meat1", "1234", "meat@gmail.com", "Hunter Place", "pascal", "Highway Road 10",
        ...
        restaurants.add (new Restaurants("pizza1", "1234", "pizza@gmail.com", "Pomodoro", "toni", "Beautiful Road 35",
        ...
        restaurants.add (new Restaurants("japanese1", "1234", "japanese@gmail.com", "Oishii Udon", "yoshida", "Michel Road 50",
        ...
        restaurants.add (new Restaurants("korean1", "1234", "korean@gmail.com", "The spicy House", "seon", "Victoria Road 14",
...
//    };
    ...
    public void addARestaurant (Restaurants restaurant){
